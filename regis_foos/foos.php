...
$sql = "INSERT into foos (Team_Name, Player1_Name, Contact1, College1, College_Id1 ,Player2_Name, Contact2, College2,College_Id2 ,Player3_Name, Contact3, College3, College_Id3,Player4_Name, Contact4, College4,College_Id4 , Player5_Name, Contact5, College5,College_Id5) values ('$team','$user1','$mail1','$clg1','$cid1','$user2','$mail2','$clg2' ,'$cid2', '$user3','$mail3','$clg3' ,'$cid3', '$user4','$mail4','$clg4','$cid4' ,  '$user5','$mail5','$clg5','$cid5')";
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">foos Registration Form</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
...
<br><br><br>
                        ...
                        <div class="form-row">
                            <div class="name">Player 5</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="user5" placeholder="Player5_Name">
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="mail5" placeholder="e.g. 9856421568">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="clg5" placeholder="College_Name">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="cid5" placeholder="College_Id">
                                </div>
                            </div>
                        </div>
